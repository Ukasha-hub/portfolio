...
const Projects = () => {
    return (
        <div className="bg-black p-5" id="projects">
            ...
            <div className="m-10 grid grid-rows-1 justify-center lg:grid-cols-3 xl:grid-cols-4 justify-items-center content-center items-center lg:flex-row md:grid-cols-2 gap-3">
